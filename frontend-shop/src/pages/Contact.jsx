                ...
                <div className='p-6 mr-auto ml-auto justify-center items-center flex w-full flex-col p-4  '>
                    ...
                    <div className='flex gap-6 items-center mt-4'>
                        <button
                            ...
                            className="transition-all hover:scale-105 duration-200 vee relative text-white font-semibold py-3 px-6 rounded-lg bg-blue-600
                        ...
                        <button
                            ...
                            className="transition-all hover:scale-105 duration-200 vee relative text-white font-semibold py-3 px-6 rounded-lg bg-green-600
